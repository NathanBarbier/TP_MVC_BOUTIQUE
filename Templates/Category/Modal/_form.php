    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="bg-gray-600 flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                <h1 id="categoryTitle" class="text-xl font-semibold text-gray-900 dark:text-white">
                    <?= !empty($_SESSION['cache']) &&  $_SESSION['cache'] === "create" ? 'Create a category' : 'Update a category' ;?>
                </h1>
                <button type="button"
            ...
            <form action="" method="post">
                ...
                <div class="p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                    <div class="w-1/4">
                        <button type="submit" name="id" id="categoryButton" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Confirmed
                        </button>
                    </div>
                </div>
